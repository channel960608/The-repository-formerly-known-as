...
import edu.neu.coe.huskySort.sort.huskySort.AbstractHuskySort;
 ...
 */
public abstract class AbstractKeySort<X extends Comparable<X>> extends SortWithHelper<X> {
     ...
     */
    protected AbstractKeySort(final String name, final int n, final HuskyCoder<X> huskyCoder, final Consumer<X[]> postSorter, final Config config) {
    ...
    private AbstractKeySort(final String name, final HuskyHelper<X> helper) {
        super(helper);
        this.name = name;
